Feature: Accounts types
  ...
  # With data driven test we don't need above 3 Scenarios
  # we can put all the repeat steps into one Scenario Outline and example and run
